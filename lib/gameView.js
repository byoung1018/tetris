(function () {
  ...
  GameView.prototype.bindSwipeHandlers = function () {
    ...
    this.$canvas.on("swiperight", "canvas", function (event) {game.safeAction("moveRight");})
    this.$canvas.on("tap", "canvas", function (event) {game.safeAction("rotate");})
    this.$canvas.on("swipeleft", "canvas", function (event) {game.safeAction("moveLeft");})
    this.$canvas.on("taphold", "canvas", function (event) {game.dropPiece();})
  };
