(function () {
  ...
  GameView.prototype.bindSwipeHandlers = function () {
    ...
    // }
    this.$canvas.on("swiperight", function () {game.safeAction("moveRight");})
    this.$canvas.on("tap", function () {game.safeAction("rotate");})
    this.$canvas.on("swipeleft", function () {game.safeAction("moveLeft");})
    this.$canvas.on("taphold", function () {game.dropPiece();})
  };
