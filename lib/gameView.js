(function () {
  ...
  GameView.prototype.bindSwipeHandlers = function () {
    ...
    // }
    this.$canvas.on("swiperight", function () {alert("swiperight"); game.safeAction("moveRight");})
    this.$canvas.on("tap", function () {alert("tap"); game.safeAction("rotate");})
    this.$canvas.on("swipeleft", function () {alert("swipeleft"); game.safeAction("moveLeft");})
    this.$canvas.on("taphold", function () {alert("taphold"); game.dropPiece();})
  };
