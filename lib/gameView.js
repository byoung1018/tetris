(function () {
  ...
  GameView.prototype.bindSwipeHandlers = function () {
    ...
    this.$canvas.on("swiperight", function (event) {game.safeAction("moveRight");})
    this.$canvas.on("tap", function (event) {game.safeAction("rotate");})
    this.$canvas.on("swipeleft", function (event) {game.safeAction("moveLeft");})
    this.$canvas.on("taphold", function (event) {game.dropPiece();})
  };
