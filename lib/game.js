(function () {
  ...
  Game.prototype.drawStart = function (ctx) {
    ...
    ctx.fillText("Press Enter for New Game", 10 * Tetris.BLOCKSIZE, 9 * Tetris.BLOCKSIZE, (10 * Tetris.BLOCKSIZE)-5);
  };
  ...
  Game.prototype.drawGameOver = function (ctx) {
    ...
    ctx.fillText("Game Over", 10 * Tetris.BLOCKSIZE, 10 * Tetris.BLOCKSIZE, (10 * Tetris.BLOCKSIZE)-5);
    ctx.font="24px Georgia";
    ctx.fillText("Press Enter for New Game", 10 * Tetris.BLOCKSIZE, 12 * Tetris.BLOCKSIZE, (10 * Tetris.BLOCKSIZE)-5);
  };
