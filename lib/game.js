(function () {
  ...
  Game.LEVELS = [1, 1.25, 1.5, 2, 2.66, 3.8, 5.25, 6.33, 9, 12.66, 18, 25, 38, 57, 76]
  ...
  Game.prototype.drawStart = function (ctx) {
    ...
    ctx.fillText("Press Enter for New Game", 10.1 * Tetris.BLOCKSIZE, 9 * Tetris.BLOCKSIZE);
  };
  ...
  Game.prototype.drawInstructions = function (ctx) {
    ...
    ctx.fillText("w - Rotate Piece", .5* Tetris.BLOCKSIZE, 2 * Tetris.BLOCKSIZE);
    ctx.fillText("a - Move Piece Left", .5 * Tetris.BLOCKSIZE, 3 * Tetris.BLOCKSIZE);
    ctx.fillText("d - Move Piece Right", .5 * Tetris.BLOCKSIZE, 4 * Tetris.BLOCKSIZE);
    ctx.fillText("s - Move Piece Down", .5 * Tetris.BLOCKSIZE, 5 * Tetris.BLOCKSIZE);
    ctx.fillText("space - Drop Piece", .5 * Tetris.BLOCKSIZE, 6 * Tetris.BLOCKSIZE);
  };
  ...
  Game.prototype.drawGoal = function (ctx) {
    ...
    ctx.fillText(this.goal, 21.6 * Tetris.BLOCKSIZE, 11 * Tetris.BLOCKSIZE);
  };
  ...
  Game.prototype.drawLevel = function (ctx) {
    ...
    ctx.stroke();
    ctx.font="40px Georgia";
    ctx.fillText(this.level + 1, 25.6 * Tetris.BLOCKSIZE, 11 * Tetris.BLOCKSIZE);
  };
